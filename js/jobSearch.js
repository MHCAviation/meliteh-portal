    ...
    if (query) {
      ...
      if (filteredData.length > 0) {
        ...
        jobCardsContainer.innerHTML = `
                    <h2>Sorry, there are no jobs available for "${query}" in "${
